        ...
        <div className={`bg-gray-900/60 p-4 rounded-xl `}>
            <Link href={`/movie/${data.id}`}>
                <a>
                    ...
                    <div className={`mt-4  `}>
                        <div className={`whitespace-nowrap text-ellipsis overflow-hidden text-lg text-white`}>{data?.title}</div>
                        <div className={`flex items-center justify-between`}>
                            ...
                            <div className={`text-sm text-white/30`}>{data?.release_date}</div>
                        </div>
                    </div>
                </a>
            </Link>
