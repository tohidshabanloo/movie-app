                ...
                <a>
                    ...
                    <div className={`mt-4  `}>
                        ...
                        <div className={`flex items-center justify-between`}>
                            <div className={`text-sm text-white/30 py-2 overflow-hidden`}>Job: <span className={`w-full block whitespace-nowrap  text-ellipsis text-yellow-500 font-bold py-2`}>{data?.job}</span></div>
                        </div>
                    </div>
                </a>
            </Link>
